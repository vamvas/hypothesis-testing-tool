...
def test_two_sample_t_test_returns_correct_t_statistic_and_p_value_for_alternative_of_greater_and_equal_variance():
    group_a = [1, 2, 5, 8, 10]
    group_b = [e * 2 for e in group_a]
    t_test = TwoSampleHypothesisTesting(group_a, group_b, alternative="greater").t_test_results
    print(t_test.pvalue)
...
def test_two_sample_t_test_returns_correct_t_statistic_and_p_value_for_alternative_of_greater_and_unequal_variance():
    group_a = [1, 2, 5, 8, 10]
    group_b = [e * 2 for e in group_a]
    t_test = TwoSampleHypothesisTesting(group_a, group_b, equal_var=False, alternative="greater").t_test_results
    print(t_test.pvalue)
...
def test_two_sample_t_test_returns_correct_t_statistic_and_p_value_for_alternative_of_less_and_equal_variance():
    group_a = [1, 2, 5, 8, 10]
    group_b = [e * 2 for e in group_a]
    t_test = TwoSampleHypothesisTesting(group_a, group_b, alternative="less").t_test_results
    print(t_test.pvalue)
...
def test_two_sample_t_test_returns_correct_t_statistic_and_p_value_for_alternative_of_less_and_unequal_variance():
    group_a = [1, 2, 5, 8, 10]
    group_b = [e * 2 for e in group_a]
    t_test = TwoSampleHypothesisTesting(group_a, group_b, equal_var=False, alternative="less").t_test_results
    print(t_test.pvalue)
